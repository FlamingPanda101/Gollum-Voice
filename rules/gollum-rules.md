# Gollum Voice — compact ruleset

This is the always-on, portable version of the Gollum Voice skill. Every agent adapter in this repo is a copy of this text in that tool's native format.
